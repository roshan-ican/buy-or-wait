...
Loosely a "repository pattern": screens never touch mock data directly — they call an interface exposed from `src/data/repositories`, so swapping in a live API later means changing one file (`src/data/repositories/index.ts`), not the screens.
